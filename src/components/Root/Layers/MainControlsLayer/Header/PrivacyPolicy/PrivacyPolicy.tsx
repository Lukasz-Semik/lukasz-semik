...
export const PrivacyPolicy = ({ isVisible, closePolicy }: Props) => {
  return (
    <Wrapper isVisible={isVisible}>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Łukasz Semik, Miedziana 29/7, 59-300
            Lubin, Poland.
          </p>
        </li>
        <li>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Łukasz Semik, accessible from{' '}
            <a
              href="https://amazing-morse-d2c52c.netlify.app/"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://amazing-morse-d2c52c.netlify.app/
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>By email: semik.lukasz@gmail.com</li>
      </ul>
    </Wrapper>
  );
};
